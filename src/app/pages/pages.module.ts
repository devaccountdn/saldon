...
@NgModule({
  declarations: [HomeComponent, AboutComponent, AboutSubpageComponent, FooterComponent, AboutResourcesComponent, ContactComponent, Covid19Component, SalePage2Component, ServiceComponent, SalePage1Component, RenovationsComponent],
  imports: [
    CommonModule,
    PagesRoutingModule
  ]
